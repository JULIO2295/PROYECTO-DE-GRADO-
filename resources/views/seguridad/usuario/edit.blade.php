...
<div class="row">
	...
	<h3>Editar Usuario: {{ $usuario->nombre.''.$usuario->apellidos}} </h3>
	<br>
	@if (count($errors)>0)
  ...
  <label for="idrol">{{ __('Rol') }}</label>
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                            <label for="username">{{ __('Username') }}</label>
                                ...
                                <input id="username" type="text" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" value="{{ $usuario->username }}" required autofocus>
            ...
            <div class="row">
                  ...
                  <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                            <label for="nombre">{{ __('Nombre') }}</label>
                                ...
                                <input id="name" type="text" class="form-control{{ $errors->has('nombre') ? ' is-invalid' : '' }}" name="nombre" value="{{ $usuario->nombre}}" required autofocus>
...
<div class="row">
          <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                          ...
                          <input id="ci" type="text" class="form-control{{ $errors->has('ci') ? ' is-invalid' : '' }}" name="ci" value="{{ $usuario->ci}}" required autofocus>
        ...
        <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                            <label for="genero">{{ __('Género') }}</label>
                                ...
                                <input id="genero" type="text" class="form-control{{ $errors->has('genero') ? ' is-invalid' : '' }}" name="genero" value="{{ $usuario->genero }}" required autofocus>
        ...
        <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                       ...
                       <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                        ...
                        <img src="{{asset('imagenes/usuarios/'.$usuario->imagen)}}" heigth="200px" width="200px">
